...
class _QuizScreenState extends State<QuizScreen> {
  ...
  Future<void> fetchExam() async {
    ...
    final url = Uri.parse("http://${HostString.hoststring}:5001/api/student/exams/${widget.examId}");
  ...
  Future<void> submitExam() async {
    final url = Uri.parse("http://${HostString.hoststring}:5001/api/student/answers/${widget.studentId}");
